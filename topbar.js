...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://aydhdrclipttbbxdzayc.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_gfril0SN-Depv0bR68EC6A_bhWg57Hg';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  <a href="daily.html" class="bottombar-tab" data-page="daily">
    <span class="bottombar-tab-icon">❤️</span><span>Daily</span>
  </a>
</nav>`;
